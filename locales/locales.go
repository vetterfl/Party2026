...
var DE = map[string]string{
	...
	"carpool.origin_ph":      "z. B. Musterstadt, Hauptbahnhof",
	"carpool.time":           "Wann",
	"carpool.time_ph":        "z. B. Samstag nachmittags",
	"carpool.seats":          "Freie Plätze",
	"carpool.seats_hint":     "Nur bei Angeboten relevant (0 = keine Angabe)",
	"carpool.note":           "Notiz (optional)",
	"carpool.note_ph":        "z. B. kleiner Umweg möglich, Platz für Gepäck …",
...
var EN = map[string]string{
	...
	"carpool.time":           "When",
	"carpool.time_ph":        "e.g. Saturday afternoon",
